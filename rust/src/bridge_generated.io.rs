...
#[no_mangle]
pub extern "C" fn wire_generate_address_from_private_key(port_: i64, input: *mut wire_uint_8_list) {
    wire_generate_address_from_private_key_impl(port_, input)
}

#[no_mangle]
pub extern "C" fn wire_sign_message_with_private_key(
    port_: i64,
...
#[no_mangle]
pub extern "C" fn wire_create_multisig_params(
    port_: i64,
    addresses: *mut wire_StringList,
    threshold: u64,
    unlock_duration: i64,
    start_epoch: i64,
) {
...
#[no_mangle]
pub extern "C" fn wire_multisig_send_propose_params(
    port_: i64,
...
#[no_mangle]
pub extern "C" fn wire_multisig_approve_params(port_: i64, txnid: i64) {
    wire_multisig_approve_params_impl(port_, txnid)
}

#[no_mangle]
pub extern "C" fn wire_message_cid(
    port_: i64,
    ...
    gas_limit: i64,
    gas_fee_cap: *mut wire_uint_8_list,
    gas_premium: *mut wire_uint_8_list,
) {
