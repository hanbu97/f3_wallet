...
class FlutterRustBridgeExampleWire implements FlutterRustBridgeWireBase {
  ...
  void wire_generate_address_from_private_key(
    int port_,
    ffi.Pointer<wire_uint_8_list> input,
  ) {
    return _wire_generate_address_from_private_key(
      port_,
      input,
    );
  }

  late final _wire_generate_address_from_private_keyPtr = _lookup<
          ffi.NativeFunction<
              ffi.Void Function(ffi.Int64, ffi.Pointer<wire_uint_8_list>)>>(
      'wire_generate_address_from_private_key');
  late final _wire_generate_address_from_private_key =
      _wire_generate_address_from_private_keyPtr
          .asFunction<void Function(int, ffi.Pointer<wire_uint_8_list>)>();

  void wire_sign_message_with_private_key(
    int port_,
    ffi.Pointer<wire_uint_8_list> msg,
    ffi.Pointer<wire_uint_8_list> private_key,
  ) {
    return _wire_sign_message_with_private_key(
      port_,
      msg,
      private_key,
    );
  ...
  late final _wire_sign_message_with_private_keyPtr = _lookup<
          ffi.NativeFunction<
              ffi.Void Function(ffi.Int64, ffi.Pointer<wire_uint_8_list>,
                  ffi.Pointer<wire_uint_8_list>)>>(
      'wire_sign_message_with_private_key');
  late final _wire_sign_message_with_private_key =
      _wire_sign_message_with_private_keyPtr.asFunction<
          void Function(int, ffi.Pointer<wire_uint_8_list>,
              ffi.Pointer<wire_uint_8_list>)>();

  void wire_create_multisig_params(
    int port_,
    ffi.Pointer<wire_StringList> addresses,
    int threshold,
    int unlock_duration,
    int start_epoch,
  ) {
    return _wire_create_multisig_params(
      port_,
      addresses,
      threshold,
      unlock_duration,
  ...
  late final _wire_create_multisig_paramsPtr = _lookup<
      ffi.NativeFunction<
          ffi.Void Function(ffi.Int64, ffi.Pointer<wire_StringList>, ffi.Uint64,
              ffi.Int64, ffi.Int64)>>('wire_create_multisig_params');
  late final _wire_create_multisig_params =
      _wire_create_multisig_paramsPtr.asFunction<
          void Function(int, ffi.Pointer<wire_StringList>, int, int, int)>();

  void wire_multisig_send_propose_params(
    int port_,
    ffi.Pointer<wire_uint_8_list> to,
    ffi.Pointer<wire_uint_8_list> value,
  ) {
    return _wire_multisig_send_propose_params(
      port_,
      to,
      value,
    );
  ...
  late final _wire_multisig_send_propose_paramsPtr = _lookup<
          ffi.NativeFunction<
              ffi.Void Function(ffi.Int64, ffi.Pointer<wire_uint_8_list>,
                  ffi.Pointer<wire_uint_8_list>)>>(
      'wire_multisig_send_propose_params');
  late final _wire_multisig_send_propose_params =
      _wire_multisig_send_propose_paramsPtr.asFunction<
          void Function(int, ffi.Pointer<wire_uint_8_list>,
              ffi.Pointer<wire_uint_8_list>)>();

  void wire_multisig_approve_params(
    int port_,
    int txnid,
  ) {
    return _wire_multisig_approve_params(
      port_,
      txnid,
    );
  }

  late final _wire_multisig_approve_paramsPtr =
      _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Int64, ffi.Int64)>>(
          'wire_multisig_approve_params');
  late final _wire_multisig_approve_params =
      _wire_multisig_approve_paramsPtr.asFunction<void Function(int, int)>();

  void wire_message_cid(
    int port_,
    ...
    int gas_limit,
    ffi.Pointer<wire_uint_8_list> gas_fee_cap,
    ffi.Pointer<wire_uint_8_list> gas_premium,
  ) {
    return _wire_message_cid(
      port_,
      from,
      to,
      nonce,
  ...
  late final _wire_message_cidPtr = _lookup<
      ffi.NativeFunction<
          ffi.Void Function(
              ffi.Int64,
              ffi.Pointer<wire_uint_8_list>,
              ...
              ffi.Int64,
              ffi.Pointer<wire_uint_8_list>,
              ffi.Pointer<wire_uint_8_list>)>>('wire_message_cid');
  late final _wire_message_cid = _wire_message_cidPtr.asFunction<
      void Function(
          int,
          ffi.Pointer<wire_uint_8_list>,
          ffi.Pointer<wire_uint_8_list>,
